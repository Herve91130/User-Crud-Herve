...
<body>
    <div class="container">
        ...
        <form method="POST" action="/user-crud/router.php/modifier-mendiant?id=<?= $user->id ?>" enctype="multipart/form-data" class="p-5">
            <div class="form-group">
                <label>Nom</label>
                <input type="text" name="user-lastname" class="form-control" value="<?= $user->nom ?>">
            </div>
            <div class="form-group">
                <label>Prénom</label>
                <input type="text" name="user-firstname" class="form-control" value="<?= $user->prenom ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" name="user-password" class="form-control" value="<?= $user->mot_de_passe ?>">
            </div>
